...
pub mod tests {
    ...
    use crate::test_utils::{gen_f64, gen_f64_with_max, gen_usize, gen_usize_between, gen_usize_with_max, gen_vec};
    ...
    fn test_net_signals(tc: TestCase) {
        ...
        let signals = strategy._net_signals(&mock_deps, &mut net, &feat_table, data_range, delay);
