...
class NodeFields extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Widget? fields = switch (nodeData) {
      ...
      NormalizedSMA() => const OhlcWindowFeatureContent(),
      NormalizedEMA() => const EmaFeatureContent(),
      NormalizedMACD() => const MacdFeatureContent(),
      RSI() => const RsiFeatureContent(),
      NormalizedBB() => const BollingerBandsFeatureContent(),
      Stochastic() => const StochasticFeatureContent(),
      NormalizedATR() => const AtrFeatureContent(),
      ROC() => const OhlcWindowFeatureContent(),
      NormalizedDC() => const DonchianChannelFeatureContent(),
      ThresholdRange() => const ThresholdRangeFields(),
      MetaAction() => const MetaActionFields(),
      LogicActions() => const LogicActionsFields(),
      DecisionActions() => const DecisionActionsFields(),
