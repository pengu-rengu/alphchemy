...
- `id` cannot be selected, filtered, or sorted; each window-selected value is annotated with its experiment id in parentheses, e.g. `0.42 (100)`. ISO-8601 timestamp values are shown as `Jan 2 2026 12:00`
